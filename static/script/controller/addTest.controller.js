define(['app'], function(app) {
    app.controller('addExamCtrl', ['$rootScope', '$scope', '$http','$interval','FileUploader', function($rootScope, $scope, $http,$interval,FileUploader) {
        ...
        uploader.onAfterAddingFile = function (fileItem) {
            ...
            reader.addEventListener("load",function (e) {
                ...
                $scope.$apply(function () {
                    $scope.mmmmmmmmm = e.target.result;
                },false)
            });
