 ...
 * 
 * */
define(['angular', 'slimscroll', 'jquery'], function (angular) {
        ...
        function () {
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    if (attrs.zhcsSlim == "" || attrs.zhcsSlim == "true") {
     ...
     * ------------------------------------------------------------------
     */
    module.directive('zhcsDatePicker', function ($filter) {
        return {
            require: '?ngModel',
            restrict: 'A',
